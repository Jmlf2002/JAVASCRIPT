...
if(price != 0)
{
document.getElementById("or1").innerHTML += quantity + "x &nbsp;&nbsp;&nbsp; HAM AND CHEESE - ₱320.00<br>";
}
};
...
if(price != 0)
{
document.getElementById("or1").innerHTML += quantity + "x &nbsp;&nbsp;&nbsp;&nbsp; CHEESY VEGGIES PIZZA - ₱330.00<br>";
}
};
...
if(price != 0)
{
document.getElementById("or1").innerHTML += quantity + "x &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; PEPPERONI PIZZA -  ₱350.00<br>";
}
};
...
if(price != 0)
{
document.getElementById("or1").innerHTML += quantity + "x &nbsp;&nbsp;&nbsp;&nbsp; CHEESE CLASSIC PIZZA - ₱400.00<br>";
}
};
...
if(price != 0)
{
document.getElementById("or1").innerHTML += quantity + "x &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CHICKEN BARBERQUE PIZZA - ₱550.00<br>";
}
};
...
if(price != 0)
{
document.getElementById("or1").innerHTML += quantity + "x &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; HEART PIZZA - ₱320.00<br>";
}
};
